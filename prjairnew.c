...
void front()
{
	...
	output(300,130,"ACADEMY FOR TECHNICAL AND MANAGEMENT EXCELLENCE  ",fonts[3]);
	glColor3f(0.3,0.5,0.8);
	output(310,100,"    DEPT. OF COMPUTER SCIENCE & ENGG.",fonts[0]);
	glColor3f(0.8,0.1,0.2);
	output(190,600,"                                     GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[3]);
	glColor3f(1.0,0.0,1.0);
	output(400,500,"SUBMITTED BY :",fonts[0]);
	output(400,350,"UNDER THE GUIDANCE OF :",fonts[0]);
	glColor3f(0.3,0.5,0.8);
	output(180,450,"PRAJWAL S K",fonts[3]);
	output(680,450,"PRATIKSHA N",fonts[3]);
	output(180,300,"Mr. ANANDA KUMAR B N",fonts[3]);
	output(640,300,"Ms. KEERTHANA M M",fonts[3]);
	glColor3f(0.0,0.6,0.3);
	output(180,400,"(4AD13CS053)",fonts[0]);
	output(680,400,"(4AD13CS054)",fonts[0]);
	output(200,250,"Asst prof,Dept. of CS&E",fonts[0]);
	output(620,250,"Asst prof,Dept. of CS&E",fonts[0]);
